...
public class CmdPORT extends Command {
    ...
    public void run() {
        ...
        cmdChannel.getDataChannel().setPortSocket(dataSocket);
        cmdChannel.writeResponse("220 Service ready. Data cmdChannel is open.");
    }
}
